...
class HomeController extends Controller
{
                    ...
                    <div class="product">
                        <div class="product-img">
                            ...
                            <ul class="product-chose">
                                ...
                                <li><a ><i
                                            class="add_to_cart add-to-wishlist fa-solid fa-cart-shopping"></i></a>
                                </li>
                            </ul>
                        </div>
    ...
    public function mainProductToday($productList){
        $textProduct ="";
        foreach($productList AS $eachProduct)
		{
            ...
            $textProduct .= 
            '
                <div class="col-lg-3 col-xl-3 col-md-6 item '.strtolower($eachProduct['tenncc']).' hidden">
                    <div class="product ">
                        <div class="product-img">
                            <img class = "product-img-link" src="'.$GLOBALS['PRODUCT_DIRECTORY_SHOW'].$eachProduct['tendanhmuc']."/"."Thumbnail/".$eachProduct['anh'].'" alt="">
                            <div class="product-label">
