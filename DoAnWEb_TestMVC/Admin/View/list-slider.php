                  ...
                  <tbody>
                    <tr>
                        ...
                        <td class="satus slider">
                          <label class="toggle-switchy pl-2" for="status-silder-check-1" data-size="sm" data-text="false"
                            ...
                            <input checked="" type="checkbox" id="status-silder-check-1">
                            <span class="toggle">
                    ...
                    <tr>
                        ...
                        <td class="satus slider">
                          <label class="toggle-switchy pl-2" for="status-silder-check" data-size="sm" data-text="false"
                            data-style="rounded" data-toggle="collapse" data-target="#filterbar" aria-expanded="true"
                            aria-controls="filterbar" id="filter-btn" onclick="changeBtnTxt()">
                        ...
                        <td class="action slider">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu action--none">
                              ...
                              <a class="dropdown-item" href="edit_silder.php"><i class="bx bx-edit-alt me-1"></i>
                               sửa</a>
                              <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Xóa</a>
                            </div>
                          </div>
