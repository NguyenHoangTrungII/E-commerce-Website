          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              ...
              <div class="table-responsive text-nowrap">
                <table id="content" class="table user">
                  <thead>
                    <tr>
                ...
                <div id="paging" class="paging d-flex justify-content-end px-5 py-4">
...
<script>
            ...
            if(piece.substring(0, 5) === 'page=') {
               ...
               page = 1;
                 ...
                 alert(page);
                $.ajax({
                     url :  "http://localhost/DoAnWeb/DoAnWeb_testMVC/admin/Controller/Employee/paging.php",
                     type : "POST",
