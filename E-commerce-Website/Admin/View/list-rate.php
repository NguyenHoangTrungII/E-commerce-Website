                                ...
                                <table class="table user">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="action rate">Thao tác</th>
                                                        ...
                                                        <div class="col-xl">
                                                            <div class="card mb-4">
                                                                <div
                                                                    ...
                                                                    <h5 class="mb-0">Thông tin <span>Đánh giá</span>
                                                                    </h5>
                                                                    ...
                                                                    <form>
                                                                        ...
                                                                        <div class="mb-3 col-xl-12">
                                                                            <label class="form-label"
                                                                                ...
                                                                                dùng: </label>
                                                                            <label class="form-label"
                                                                                for="basic-default-fullname">Nguyễn Hoàng Trung</label>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="mb-3 col-md-6">
                                                                                <label class="form-label"
                                                                                for="basic-default-date_post">Ngày đăng: </label>
                                                                                <label class="form-label"
                                                                                for="basic-default-date_post">1/1/2020 </label>

                                                                            </div>

                                                                            <div class="mb-3 col-md-6">
                                                                                <label class="form-label"
                                                                                for="basic-default-date_post">Sản phẩm: </label>
                                                                                <label class="form-label"
                                                                                for="basic-default-date_post">Intel i7 </label>
                                                                            </div>
                                                                        </div>
